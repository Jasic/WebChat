...
import com.lemontree.exception.ParseMessageException;
import com.lemontree.util.MessageUtil;
import com.lemontree.webchat.protocol.bean.Event;
import com.lemontree.webchat.protocol.req.*;
import com.lemontree.webchat.protocol.req.event.*;
...
//            String decodeStr = URLDecoder.decode(body, charset.displayName());
            String decodeStr = URLDecoder.decode(body);
            // xml请求解析
