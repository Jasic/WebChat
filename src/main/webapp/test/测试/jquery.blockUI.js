 ...
 * Modify: fengxq
 * date  : 2008-01-22
 * line  : 300 行      Add         $('iframe',els).remove();
 * line  : 296 行      Add         this.center(m[0]);
 */
 (function($) {
/**
...
$.blockUI.defaults = {
    ...
    pageMessageCSS:    {  margin:'0 0 0 0', textAlign:'center', color:'#000'},
